...
- Name: hero.spec.ts >> Hero Section / Slideshow (Tier 2) >> test_hero_next_click: next button click should transition to the second slide
- Location: tests\hero.spec.ts:51:7
...
Call log:
  ...
  - waiting for locator('.slide').first()
    12 × locator resolved to <div class="slide" onclick="openLightbox(0)">…</div>
