...
- Name: scroll.spec.ts >> Smooth Scroll & Sticky Nav (Tier 2) >> test_scroll_offset_navigation: clicking anchor navigates and offsets for navbar
- Location: tests\scroll.spec.ts:36:7
...
Call log:
  - waiting for locator('a[href="index.html#pedagogia"]')
    - locator resolved to <a href="index.html#pedagogia">Pedagogía Waldorf</a>
