...
- Name: hero.spec.ts >> Hero Section / Slideshow (Tier 2) >> test_hero_prev_click: prev button click should transition to the last slide
- Location: tests\hero.spec.ts:66:7
...
Call log:
  ...
  - waiting for locator('.slide').first()
    10 × locator resolved to <div class="slide" onclick="openLightbox(0)">…</div>
