...
- Name: hero.spec.ts >> Hero Section / Slideshow (Tier 2) >> test_hero_animation_lock: rapid double clicks are locked by isAnimating
- Location: tests\hero.spec.ts:93:7
...
Call log:
  ...
  - waiting for locator('.slide').nth(1)
    14 × locator resolved to <div class="slide" onclick="openLightbox(1)">…</div>
