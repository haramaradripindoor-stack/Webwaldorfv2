...
- Name: hero.spec.ts >> Hero Section / Slideshow (Tier 2) >> test_hero_hover_pause: hover over slideshow should pause the slideshow auto-advance
- Location: tests\hero.spec.ts:106:7
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - contentinfo [ref=e150]:
      - paragraph [ref=e151]:
        ...
        - text: ✉️
        - link "coordinacion@colegiowaldorftrekan.cl" [ref=e153]:
  ...
  - link "Contactar por WhatsApp" [ref=e155]:
