...
- Name: hero.spec.ts >> Hero Section / Slideshow (Tier 2) >> test_hero_dot_click: clicking a dot transitions directly to that slide
- Location: tests\hero.spec.ts:82:7
...
Call log:
  ...
  - waiting for locator('.slide').nth(2)
    14 × locator resolved to <div class="slide" onclick="openLightbox(2)">…</div>
