              ...
              <div key={mes} className="w-full">
                ...
                <div className="flex flex-col w-full relative">
                  {(actividades as MarkdownPost[]).map((post: MarkdownPost, i: number) => {
                    ...
                    const fallbackImages = ['/imagenes-web/fiesta%20de%20la%20luz20261.jpg', '/imagenes-web/actividapedagogicahumedales1.jpg', '/imagenes-web/paseocerro20261.jpg', '/imagenes-web/comisionobraymantencion2.webp', '/imagenes-web/photo_2025-06-11_11-43-23.jpg'];
                    
                    let rawHover = post.image_url || post.image || fallbackImages[i % fallbackImages.length];
                    if (rawHover.startsWith('/images/')) {
                      rawHover = rawHover.replace('/images/', '/imagenes-web/');
