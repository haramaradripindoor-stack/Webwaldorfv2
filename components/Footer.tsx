      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        <div className="md:col-span-2">
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/waldorftrekanpv/" target="_blank" rel="noopener noreferrer" aria-label="Seguir a Colegio Waldorf Trekan en Instagram" className="w-10 h-10 rounded-full bg-[var(--color-waldorf-cream)] border border-[var(--color-waldorf-sage)]/20 flex items-center justify-center text-[var(--color-waldorf-moss)] hover:bg-[var(--color-waldorf-moss)] hover:text-[var(--color-waldorf-cream)] transition-all duration-300 earth-shadow">
              <Instagram size={18} />
            </a>
            <a href="https://www.facebook.com/profile.php?id=61573063135723" target="_blank" rel="noopener noreferrer" aria-label="Seguir a Colegio Waldorf Trekan en Facebook" className="w-10 h-10 rounded-full bg-[var(--color-waldorf-cream)] border border-[var(--color-waldorf-sage)]/20 flex items-center justify-center text-[var(--color-waldorf-moss)] hover:bg-[var(--color-waldorf-moss)] hover:text-[var(--color-waldorf-cream)] transition-all duration-300 earth-shadow">
              <Facebook size={18} />
            </a>
          </div>
        </div>
