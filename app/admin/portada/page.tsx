...
export default function PortadaEditor() {
  ...
  const [content, setContent] = useState<any>({
    hero_section: { title: 'La Vida en Trekan', subtitle: 'Educación con sentido', media_url: '/videos/Waldorf_school_logo_animation_202607082053.mp4', media_type: 'video' },
    ...
    masonry_gallery: [
      ...
      { url: '/images/fiesta de la luz202610.jpg', alt: 'Ritmos y tradiciones', span: 'col-span-1 row-span-2' },
      ...
      { url: '/images/fiesta de la luz20268.jpg', alt: 'Luz y calidez', span: 'col-span-1 row-span-1' }
    ]
  });
