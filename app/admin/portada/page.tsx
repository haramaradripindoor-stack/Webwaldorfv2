...
export default function PortadaEditor() {
  ...
  const [content, setContent] = useState<any>({
    ...
    masonry_gallery: [
      ...
      { url: '/imagenes-web/fiesta de la luz202610.jpg', alt: 'Ritmos y tradiciones', span: 'col-span-1 row-span-2' },
      ...
      { url: '/imagenes-web/fiesta de la luz20268.jpg', alt: 'Luz y calidez', span: 'col-span-1 row-span-1' }
    ]
  });
