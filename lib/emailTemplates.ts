        ...
        rows: [{
          ...
          columns: [{
            contents: [
              ...
              { type: "text", values: { text: "<p style=\"text-align: left; color: #4A4A4A; font-size: 16px; line-height: 1.6; font-family: 'Helvetica', sans-serif; padding: 20px;\">Estimada familia,<br/><br/>Creemos profundamente que un colegio no se conoce leyendo un folleto, sino sintiendo el espacio. Por eso, antes de avanzar en nuestro proceso de Admisión 2027, queremos extenderles una invitación muy especial.<br/><br/>Nos encantaría que vengan a compartir una jornada con nosotros. Queremos abrirles las puertas de nuestro refugio en Puerto Varas para tomarnos un té, conversar sin apuros y que puedan vivenciar en primera persona cómo acompañamos el aprendizaje y desarrollo de los niños y niñas.<br/><br/>Será una instancia íntima donde podrán resolver todas sus inquietudes sobre nuestra pedagogía, conocer a los maestros y respirar el ambiente en el que sus hijos pasarían sus próximos años.<br/><br/><strong>Como queremos mantener la calidad y calidez de la conversación, los cupos para este encuentro son limitados.</strong><br/><br/>Si desean acompañarnos, por favor confirmen su asistencia haciendo clic en el botón de abajo.<br/><br/>Los esperamos con los brazos abiertos,<br/><strong>Ivonne y el Equipo Trekan</strong></p>" } },
        ...
        rows: [{
          ...
          columns: [{
            contents: [
              ...
              { type: "text", values: { text: "<p style=\"text-align: left; color: #4A4A4A; font-size: 16px; line-height: 1.6; font-family: 'Helvetica', sans-serif; padding: 20px;\">Estimada familia,<br/><br/>Nos dirigimos a ustedes con especial entusiasmo porque, en el pasado, nos confiaron su interés en nuestro proyecto educativo. Hoy, queremos honrar esa cercanía dándoles un aviso prioritario: <strong>hemos abierto oficialmente el proceso de Admisión y Matrículas para el Ciclo Escolar 2027.</strong><br/><br/>Sabemos que elegir el entorno donde sus hijos crecerán y se formarán es una de las decisiones más profundas que toman como padres. En el Colegio Waldorf Trekan, no solo ofrecemos un modelo académico, sino un refugio de aprendizaje; un ecosistema donde respetamos los ritmos biológicos de la infancia, alejados de la sobreestimulación y enfocados en el desarrollo integral de cada niño.<br/><br/>Para garantizar la calidad absoluta de este acompañamiento y proteger la calidez de nuestras salas, <strong>mantenemos un límite estricto e innegociable de máximo 16 niños por curso.</strong><br/><br/>Por la naturaleza de nuestro modelo, los cupos disponibles son escasos. Como ustedes ya habían demostrado interés previo, queríamos asegurarnos de que recibieran esta información a tiempo.<br/><br/>Si sienten el llamado de sumarse a nuestra comunidad, los invitamos a dar el siguiente paso. Toda la información sobre nuestra propuesta, valores y el formulario de postulación ya se encuentran disponibles en nuestra plataforma web.<br/><br/><strong>El Equipo del Colegio Waldorf Trekan</strong></p>" } },
