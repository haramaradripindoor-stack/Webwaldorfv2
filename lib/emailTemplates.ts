        ...
        rows: [{
          ...
          columns: [{
            contents: [
              ...
              { type: "text", values: { text: "<p style=\"text-align: center; color: #A3B19B; font-size: 12px; margin-top: 30px;\">Colegio Waldorf Trekan · Puerto Varas<br/><br/><a href=\"*|UNSUB|*\" style=\"color: #A3B19B; text-decoration: underline;\">Darse de baja de nuestra lista</a></p>" } }
            ]
          }],
        ...
        rows: [{
          ...
          columns: [{
            contents: [
              ...
              { type: "text", values: { text: "<p style=\"text-align: center; color: #A3B19B; font-size: 12px; margin-top: 30px;\">Colegio Waldorf Trekan · Puerto Varas<br/><br/><a href=\"*|UNSUB|*\" style=\"color: #A3B19B; text-decoration: underline;\">Darse de baja</a></p>" } }
            ]
          }],
          values: { backgroundColor: "#F9F8F5" }
        }],
