...
- Name: scroll.spec.ts >> Boundaries (Tier 2) >> test_admission_fields_validation: parentName and childrenAges are required
- Location: tests\scroll.spec.ts:59:7
...
Locator: locator('input[name="parentName"]')
Expected: ""
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[name="parentName"]')
    - waiting for" http://127.0.0.1:3000/admision" navigation to finish...
    - navigated to "http://127.0.0.1:3000/admision"
