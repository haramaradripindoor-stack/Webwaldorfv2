...
- Name: scroll.spec.ts >> Navbar & Global Widgets (Tier 1) >> test_custom_cursor_present: custom cursor element should be in DOM
- Location: tests\scroll.spec.ts:14:7
...
Locator: locator('div.fixed.pointer-events-none.z-\\[9999\\]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div.fixed.pointer-events-none.z-\\[9999\\]')
